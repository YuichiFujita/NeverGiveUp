...
HRESULT CSceneGame::Init(void)
{
	...
	// ビルオブジェクトの生成
	//CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(0.0f,     0.0f, 0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 360.0f, 120.0f), XCOL_WHITE);
	//CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-400.0f,  0.0f, 0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 300.0f, 120.0f), XCOL_WHITE);
	...
	//CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-1200.0f, 0.0f, 0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 180.0f, 120.0f), XCOL_WHITE);
	//CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-1600.0f, 0.0f, 0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 120.0f, 120.0f), XCOL_WHITE);
	//CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2000.0f, 0.0f, 0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f,  120.0f), XCOL_WHITE);

	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2240.0f, 0.0f,    0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2240.0f, 0.0f,  240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2240.0f, 0.0f, -240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2000.0f, 0.0f,    0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2000.0f, 0.0f,  240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-2000.0f, 0.0f, -240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-1760.0f, 0.0f,    0.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-1760.0f, 0.0f,  240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
	CBuilding::Create(CBuilding::TYPE_NORMAL, D3DXVECTOR3(-1760.0f, 0.0f, -240.0f), VEC3_ZERO, D3DXVECTOR3(120.0f, 60.0f, 120.0f), XCOL_WHITE);
